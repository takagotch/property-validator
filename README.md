...
```js
// test/request_assertions_test.js
    ...
    describe('Invalid Assertions', function() {
      ...
      it('throws an error when properties are invalid', function() {
        assert.throws(function() {
          validator.assert(invalidProperties, [email('email_address')])
        }, ValidationError)
      })
      ...
      it('returns all errors', function() {
        try {
          ...
          var expectedError = {
            field: 'email_address',
            message: '"email_address" should lock like an email address'
          }
      ...
      it('returns error messages', function() {
        try {
          ...
          var message = '"email_address" should lock like an email address'
